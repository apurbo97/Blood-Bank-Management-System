<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search-camp.aspx.cs" Inherits="search_camp" %>
...
<body>
    ...
    <br /><br /><br />
	 <center><h1>Search Camp to Donate Blood</h1></center>
	 <br /><br /><br />
    ...
    <div class="row">
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                <center><asp:Button ID="Button1" class="btn btn-success"  Width="80%" 
                        runat="server" Text="Search" onclick="Button1_Click" /></center>
            </div>
             ...
             <table class="table table-striped table-bordered" >
                                ...
                                <tbody>
                                    <%
                                        if (htmlStr == "")
                                        {
                                            Response.Write("<tr><td colspan='7'>No Data Found  <a href='generate-id.aspx' class='btn btn-warning pull-right'>Get Donor ID</a></td></tr>");
                                        }
                                        else
                                        {
