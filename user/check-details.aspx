<%@ Page Language="C#" AutoEventWireup="true" CodeFile="check-details.aspx.cs" Inherits="user_check_details" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Check Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
              <!-- /.row -->
