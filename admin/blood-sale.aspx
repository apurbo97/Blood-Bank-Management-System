<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blood-sale.aspx.cs" Inherits="admin_blood_sale" %>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Blood Sale</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
