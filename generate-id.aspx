<%@ Page Language="C#" AutoEventWireup="true" CodeFile="generate-id.aspx.cs" Inherits="generate_id" %>
...
<body>
    ...
    <br /><br /><br />
	 <center><h1>Generate Donor ID</h1></center>
    <br /><br /><br />
        ...
        <form id="form1" runat="server">
           <div class="row">
                <div class="col-md-6">
                    ...
                    <label>Name</label>
                        <asp:TextBox ID="TextBox1" class="form-control" placeholder="Enter Doner Name" required runat="server" TextMode="SingleLine"></asp:TextBox>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Mobile</label>
                        <asp:TextBox ID="TextBox2" class="form-control" placeholder="Enter Mobile Number" required runat="server" MaxLength="10"></asp:TextBox>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Address</label>
                        <asp:TextBox ID="TextBox3" class="form-control" placeholder="Enter Doner Address" required runat="server" TextMode="MultiLine"></asp:TextBox>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                         <label>Age</label>
                         <asp:TextBox ID="TextBox4" class="form-control" placeholder="Enter Doner Age" required runat="server" TextMode="SingleLine" MaxLength="2"></asp:TextBox>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                         <label>Weight</label>
                         <asp:TextBox ID="TextBox5" class="form-control" placeholder="Enter Doner Weight" required runat="server" TextMode="SingleLine"  MaxLength="3"></asp:TextBox>
                ...
                <div class="col-md-12">
                        <center>
                            ...
                            <div class="form-group">
                            <div >
                                <asp:Button ID="Button2" class="btn btn-success" Width="40%" runat="server" 
                                    Text="Save" onclick="Button2_Click" />
                            </div>
                            </div>
                            <div class="form-group" >
                            <asp:Button ID="Button1" class="btn btn-warning" Width="40%" runat="server" 
                                    Text="Print"  Enabled="False" onclick="Button1_Click" />
                              
                            </div>
                            <div class="form-group" >
                                <button class="btn btn-info" style="width : 40%" type="reset">Clear</button>
                            </div>
