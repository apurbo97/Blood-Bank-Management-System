        ...
        <form id="form1" runat="server">
           <div class="row">
                <div class="col-md-12">
                    ...
                    <label>Name</label>
                        <asp:TextBox ID="TextBox1" class="form-control" placeholder="Enter Your Name" required runat="server" TextMode="SingleLine"></asp:TextBox>
                    </div>
                </div> 
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Mobile</label>
                        <asp:TextBox ID="TextBox2" type="number" class="form-control" placeholder="Enter Mobile Number" required runat="server" TextMode="SingleLine"></asp:TextBox>
                    </div>
                </div> 
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Email ID</label>
                        <asp:TextBox ID="TextBox4" class="form-control" placeholder="Enter Email ID" type="email" required runat="server" TextMode="SingleLine"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Discription</label>
                        <asp:TextBox ID="TextBox3" class="form-control" placeholder="Discription" required runat="server" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div> 
                <div class="col-md-12">
                        <center>
