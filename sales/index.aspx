<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="sales_index" %>
...
<body>
    ...
    <div class="form-group">
        <asp:Button ID="Button1" runat="server" class="btn btn-info" Width="100%" Text="Login" onclick="Button1_Click"  />
    </div>
    </form>
    </div>
    <div class="col-md-4">&nbsp;</div>
